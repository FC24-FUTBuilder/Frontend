...
const Registration: React.FC<Props> = ({ onRegister }) => {
  ...
  <source src="src/assets/reg.mp4" type="video/mp4"/>
    ...
    <div className="form-box">
      ...
      <form>
        <label className="plabel" htmlFor="username">Username</label><br/>
        <input
        ...
        />
        <br /><br/>
        <label className="elabel" htmlFor="email">Email</label><br/>
        <input
        className="inputfield"
          type="email"
          id="email"
        ...
        />
        <br /><br/>
        <label className="plabel" htmlFor="password">Password</label><br/>
        <input
        className="inputfield"
          type="password"
          id="password"
